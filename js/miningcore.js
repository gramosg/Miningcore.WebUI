...
var WebURL         = window.location.protocol + "//" + window.location.host + "/";  // Website URL is:  https://domain.com/
...
var stratumAddress = window.location.host;           				// Stratum address is:  domain.com
